  ...
  fluidRow(
    ...
    column(
      ...
      div(
        ...
        checkboxGroupInput(
          'overlap_filter', h4('Überschneidung der Einsätze mit radar-basierten Starkregenereignissen'), #Titel ändern?
          choices = list('zeitliche und räumliche Überschneidung' = 1, 
                         'zeitliche Überschneidung' = 2, 
                         'räumliche Überschneidung' = 3, 
                         'Überschneidung mit Medienberichten ' = 4), #Anpassen für korrekte Beschriftung
          selected = 1:4
        )
      )
    ),
...
server <- function(input, output, session) {
  ...
  observeEvent(input$show_about, {
    showModal(modalDialog(HTML("Die Webanwendung basiert auf Einsatzerhebungen der Feuerwehren im Zeitraum von Januar 2011 bis Dezember 2021. Der Datensatz umfasst alle Einsätze im Oberland, die in Zusammenhang mit Unwettern und/oder Überschwemmungen und/oder Wasserschäden stehen. Diese Daten wurden dem KARE-Team freundlicherweise von den Feuerwehren X, X, X und X zur Verfügung gestellt.<br><br> 
                          ...
                          Sollten Sie weitere Fragen haben, wenden Sie sich bitte an Annika.Schubert@lmu.de.<br><br>
                          LIZENZ EINFÜGEN<br><br>
                          Beteiligte Forschende: Dr. Anne von Streit, Dr. Gamze Koc, Annika Schubert, Felix Bauer     "), #Checkbox-Group erklären
                          footer = tagList(
